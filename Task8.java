...
<body data-new-gr-c-s-check-loaded="14.1111.0" data-gr-ext-installed="">
	<div class="box">
		...
		<table>
			...
			<tr>
				<td style="text-align: left,!important"><input type="radio" id="others" name="fav_language" value="OTHERS">
			...
			<tr>
				<td>Address:</td>
				<td><textarea id="text" form="registration"></textarea></td>
			</tr>
			<tr>
				<td>State:</td>
				<td><input id="text" type="text"></td>
			...
			<tr>
				...
				<td><input type="radio" id="eng" name="fav_language" value="ENGLISH">
            <label for="eng">English</label>
            <input type="radio" id="kan" name="fav_language" value="KANNADA">
            ...
            <label for="tel">Telugu</label></td>
			</tr>
			<tr>
				<td><input type="checkbox" id="declaration"></td>
				<td>Hereby I declare all the given details are true</td>
			</tr>
			<tr>
